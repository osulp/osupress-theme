...
/**
 * @file
 * Display Suite Bootstrap 4 8 Reponsive template.
 *
 * Available variables:
 *
 * Layout:
...
<<?php print $layout_wrapper; print $layout_attributes; ?> class="<?php print $classes;?> clearfix">
  ...
  <div class="row-fluid responsive">
    <<?php print $left_wrapper; ?> class="span4 sm-12 <?php print $left_classes; ?>">
      <?php print $left; ?>
    </<?php print $left_wrapper; ?>>

    <<?php print $right_wrapper; ?> class="span8 sm-12 <?php print $right_classes; ?>">
      <?php print $right; ?>
